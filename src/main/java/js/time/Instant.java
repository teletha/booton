...
class Instant implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
     ...
     * local date-time. The value is also chosen such that the value of the year fits in an
     * {@code int}.
     */
     ...
     * <p>
     * This is one year later than the maximum {@code LocalDateTime}. This provides sufficient
     * values to handle the range of {@code ZoneOffset} which affect the instant in addition to the
     * local date-time. The value is also chosen such that the value of the year fits in an
     * {@code int}.
     */
     ...
     * <p>
     * This checks if this instant can be queried for the specified field. If false, then calling
     ...
     * <p>
     * This queries this instant for the value of the specified field. The returned value will
     ...
     * date-time, except {@code INSTANT_SECONDS} which is too large to fit in an {@code int} and
     * throws a {@code DateTimeException}. All other {@code ChronoField} instances will throw an
     * {@code UnsupportedTemporalTypeException}.
     * <p>
     * If the field is not a {@code ChronoField}, then the result of this method is obtained by
     ...
     * <p>
     * This queries this instant for the value of the specified field. If it is not possible to
     ...
     * <p>
     * This returns an {@code Instant}, based on this one, with the instant adjusted. The adjustment
     ...
     * <p>
     * This returns an {@code Instant}, based on this one, with the value for the specified field
     * changed. If it is not possible to set the value, because the field is not supported or for
     * some other reason, an exception is thrown.
     * <p>
     * If the field is a {@link ChronoField} then the adjustment is implemented here. The supported
     * fields behave as follows:
     * <ul>
     * <li>{@code NANO_OF_SECOND} - Returns an {@code Instant} with the specified nano-of-second.
     * The epoch-second will be unchanged.
     * <li>{@code MICRO_OF_SECOND} - Returns an {@code Instant} with the nano-of-second replaced by
     * the specified micro-of-second multiplied by 1,000. The epoch-second will be unchanged.
     * <li>{@code MILLI_OF_SECOND} - Returns an {@code Instant} with the nano-of-second replaced by
     * the specified milli-of-second multiplied by 1,000,000. The epoch-second will be unchanged.
     * <li>{@code INSTANT_SECONDS} - Returns an {@code Instant} with the specified epoch-second. The
     ...
     * <p>
     * This returns an {@code Instant}, based on this one, with the specified amount added. The
     ...
     * Returns a copy of this instant with the specified amount added.
     * <p>
     * This returns an {@code Instant}, based on this one, with the amount in terms of the unit
     ...
     * fields behave as follows:
     * <ul>
     * <li>{@code NANOS} - Returns a {@code Instant} with the specified number of nanoseconds added.
     * This is equivalent to {@link #plusNanos(long)}.
     * <li>{@code MICROS} - Returns a {@code Instant} with the specified number of microseconds
     * added. This is equivalent to {@link #plusNanos(long)} with the amount multiplied by 1,000.
     * <li>{@code MILLIS} - Returns a {@code Instant} with the specified number of milliseconds
     * added. This is equivalent to {@link #plusNanos(long)} with the amount multiplied by
     * 1,000,000.
     * <li>{@code SECONDS} - Returns a {@code Instant} with the specified number of seconds added.
     * This is equivalent to {@link #plusSeconds(long)}.
     * <li>{@code MINUTES} - Returns a {@code Instant} with the specified number of minutes added.
     * This is equivalent to {@link #plusSeconds(long)} with the amount multiplied by 60.
     * <li>{@code HOURS} - Returns a {@code Instant} with the specified number of hours added. This
     * is equivalent to {@link #plusSeconds(long)} with the amount multiplied by 3,600.
     * <li>{@code HALF_DAYS} - Returns a {@code Instant} with the specified number of half-days
     * added. This is equivalent to {@link #plusSeconds(long)} with the amount multiplied by 43,200
     * (12 hours).
     * <li>{@code DAYS} - Returns a {@code Instant} with the specified number of days added. This is
     * equivalent to {@link #plusSeconds(long)} with the amount multiplied by 86,400 (24 hours).
     * </ul>
     * <p>
     ...
     * @return an {@code Instant} based on this instant with the specified milliseconds added, not
     *         null
     * @throws DateTimeException if the result exceeds the maximum or minimum instant
     * @throws ArithmeticException if numeric overflow occurs
     */
     ...
     * @return an {@code Instant} based on this instant with the specified nanoseconds added, not
     *         null
     * @throws DateTimeException if the result exceeds the maximum or minimum instant
     * @throws ArithmeticException if numeric overflow occurs
     */
     ...
     * <p>
     * This returns an {@code Instant}, based on this one, with the specified amount subtracted. The
     * amount is typically {@link Duration} but may be any other type implementing the
     * {@link TemporalAmount} interface.
     * <p>
     * The calculation is delegated to the amount object by calling
     ...
     * Returns a copy of this instant with the specified amount subtracted.
     * <p>
     * This returns a {@code Instant}, based on this one, with the amount in terms of the unit
     ...
     * @return an {@code Instant} based on this instant with the specified amount subtracted, not
     *         null
     * @throws DateTimeException if the subtraction cannot be made
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     ...
     * @return an {@code Instant} based on this instant with the specified seconds subtracted, not
     *         null
     * @throws DateTimeException if the result exceeds the maximum or minimum instant
     * @throws ArithmeticException if numeric overflow occurs
     */
     ...
     * @return an {@code Instant} based on this instant with the specified milliseconds subtracted,
     *         not null
     * @throws DateTimeException if the result exceeds the maximum or minimum instant
     * @throws ArithmeticException if numeric overflow occurs
     */
     ...
     * @return an {@code Instant} based on this instant with the specified nanoseconds subtracted,
     *         not null
     * @throws DateTimeException if the result exceeds the maximum or minimum instant
     * @throws ArithmeticException if numeric overflow occurs
     */
    ...
    public <R> R query(TemporalQuery<R> query) {
        ...
        if (query == TemporalQueries.chronology() || query == TemporalQueries.zoneId() || query == TemporalQueries
                .zone() || query == TemporalQueries.offset() || query == TemporalQueries.localDate() || query == TemporalQueries
                        .localTime()) {
            return null;
        }
     ...
     * passing {@link ChronoField#INSTANT_SECONDS} and {@link ChronoField#NANO_OF_SECOND} as the
     * fields.
     * <p>
     ...
     * <p>
     * This calculates the amount of time between two {@code Instant} objects in terms of a single
     * {@code TemporalUnit}. The start and end points are {@code this} and the specified instant.
     * The result will be negative if the end is before the start. The calculation returns a whole
     * number, representing the number of complete units between the two instants. The
     * {@code Temporal} passed to this method is converted to a {@code Instant} using
     * {@link #from(TemporalAccessor)}. For example, the amount in days between two dates can be
     * calculated using {@code startInstant.until(endInstant, SECONDS)}.
     * <p>
     ...
     * , {@code MICROS}, {@code MILLIS}, {@code SECONDS}, {@code MINUTES}, {@code HOURS},
     * {@code HALF_DAYS} and {@code DAYS} are supported. Other {@code ChronoUnit} values will throw
     * an exception.
     * <p>
     * If the unit is not a {@code ChronoUnit}, then the result of this method is obtained by
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param endExclusive the end date, exclusive, which is converted to an {@code Instant}, not
     *            null
