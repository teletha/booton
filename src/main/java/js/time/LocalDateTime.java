...
class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime<LocalDate>, Serializable {
     ...
     * date-time of midnight at the start of the minimum date. This combines {@link LocalDate#MIN}
     * and {@link LocalTime#MIN}. This could be used by an application as a "far past" date-time.
     */
    public static final LocalDateTime MIN = LocalDateTime.of(LocalDate.MIN, LocalTime.MIN);

    /**
     * The maximum supported {@code LocalDateTime}, '+999999999-12-31T23:59:59.999999999'. This is
     * the local date-time just before midnight at the end of the maximum date. This combines
     * {@link LocalDate#MAX} and {@link LocalTime#MAX}. This could be used by an application as a
     ...
     * the use of an alternate clock for testing. The alternate clock may be introduced using
    ...
    public static LocalDateTime from(TemporalAccessor temporal) {
        ...
        try {
            ...
            throw new DateTimeException("Unable to obtain LocalDateTime from TemporalAccessor: " + temporal + " of type " + temporal
                    .getClass().getName(), ex);
        }
    }
     ...
     * date-time, except {@code NANO_OF_DAY}, {@code MICRO_OF_DAY}, {@code EPOCH_DAY} and
     * {@code PROLEPTIC_MONTH} which are too large to fit in an {@code int} and throw a
     * {@code DateTimeException}. All other {@code ChronoField} instances will throw an
     * {@code UnsupportedTemporalTypeException}.
     * <p>
     * If the field is not a {@code ChronoField}, then the result of this method is obtained by
     ...
     * <p>
     * The time does not affect the calculation and will be the same in the result. If the
     ...
     * <p>
     * If the resulting date-time is invalid, an exception is thrown. The time does not affect the
     ...
     * <p>
     * This returns a {@code LocalDateTime}, based on this one, with the specified amount added. The
     ...
     * Returns a copy of this date-time with the specified amount added.
     * <p>
     * This returns a {@code LocalDateTime}, based on this one, with the amount in terms of the unit
     ...
     * <p>
     * If the field is a {@link ChronoUnit} then the addition is implemented here. Date units are
     * added as per {@link LocalDate#plus(long, TemporalUnit)}. Time units are added as per
     * {@link LocalTime#plus(long, TemporalUnit)} with any overflow in days added equivalent to
     * using {@link #plusDays(long)}.
     * <p>
     ...
     * @return a {@code LocalDateTime} based on this date-time with the specified amount added, not
     *         null
     * @throws DateTimeException if the addition cannot be made
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     ...
     * <p>
     * This returns a {@code LocalDateTime}, based on this one, with the specified amount
     ...
     * @return a {@code LocalDateTime} based on this date-time with the specified amount subtracted,
     *         not null
     * @throws DateTimeException if the subtraction cannot be made
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
    ...
    /**
     * Returns a copy of this {@code LocalDateTime} with the specified number of nanoseconds
     * subtracted.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     * @param nanos the nanos to subtract, may be negative
     * @return a {@code LocalDateTime} based on this date-time with the nanoseconds subtracted, not
     *         null
     * @throws DateTimeException if the result exceeds the supported date range
     */
     ...
     * <p>
     * This returns a temporal object of the same observable type as the input with the date and
     * time changed to be the same as this.
     * <p>
     * The adjustment is equivalent to using {@link Temporal#with(TemporalField, long)} twice,
     * passing {@link ChronoField#EPOCH_DAY} and {@link ChronoField#NANO_OF_DAY} as the fields.
     * <p>
     ...
     * <p>
     * This calculates the amount of time between two {@code LocalDateTime} objects in terms of a
     * single {@code TemporalUnit}. The start and end points are {@code this} and the specified
     * date-time. The result will be negative if the end is before the start. The {@code Temporal}
     * passed to this method is converted to a {@code LocalDateTime} using
     * {@link #from(TemporalAccessor)}. For example, the amount in days between two date-times can
     * be calculated using {@code startDateTime.until(endDateTime, DAYS)}.
     * <p>
     * The calculation returns a whole number, representing the number of complete units between the
     * two date-times. For example, the amount in months between 2012-06-15T00:00 and
     * 2012-08-14T23:59 will only be one month as it is one minute short of two months.
     * <p>
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param endExclusive the end date, exclusive, which is converted to a {@code LocalDateTime},
     *            not null
     * @param unit the unit to measure the amount in, not null
     * @return the amount of time between this date-time and the end date-time
     * @throws DateTimeException if the amount cannot be calculated, or the end temporal cannot be
     *             converted to a {@code LocalDateTime}
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     */
    @Override
     ...
     * <p>
     * This returns a {@code ZonedDateTime} formed from this date-time at the specified time-zone.
     * The result will match this date-time as closely as possible. Time-zone rules, such as
     * daylight savings, mean that not every local date-time is valid for the specified zone, thus
     ...
     * overlap, where clocks are set back, there are two valid offsets. This method uses the earlier
     ...
     * {@link ZonedDateTime#withLaterOffsetAtOverlap()} on the result of this method. To throw an
     * exception when there is a gap or overlap, use
     ...
     * {@link ChronoLocalDateTime#compareTo}.
     *
     ...
     * <p>
     * This checks to see if this date-time represents a point on the local time-line after the
     * other date-time. <pre>
     ...
     * not take into account the chronology, or calendar system. This is different from the
     * comparison in {@link #compareTo(ChronoLocalDateTime)}, but is the same approach as
     * {@link ChronoLocalDateTime#timeLineOrder()}.
     *
     * @param other the other date-time to compare to, not null
     ...
     * <p>
     * This checks to see if this date-time represents a point on the local time-line before the
     * other date-time. <pre>
     *   LocalDate a = LocalDateTime.of(2012, 6, 30, 12, 00);
     *   LocalDate b = LocalDateTime.of(2012, 7, 1, 12, 00);
     *   a.isBefore(b) == true
