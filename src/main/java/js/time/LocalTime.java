...
class LocalTime implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
     ...
     * it to be used as a query via method reference, {@code LocalTime::from}.
     *
     ...
     * <p>
     * This checks if the specified unit can be added to, or subtracted from, this time. If false,
     ...
     * <p>
     * This queries this time for the value of the specified field. The returned value will always
     ...
     * time, except {@code NANO_OF_DAY} and {@code MICRO_OF_DAY} which are too large to fit in an
     ...
     * <p>
     * This queries this time for the value of the specified field. If it is not possible to return
     * the value, because the field is not supported or for some other reason, an exception is
     * thrown.
     * <p>
     * If the field is a {@link ChronoField} then the query is implemented here. The
     * {@link #isSupported(TemporalField) supported fields} will return valid values based on this
     * time. All other {@code ChronoField} instances will throw an
     * {@code UnsupportedTemporalTypeException}.
     * <p>
     * If the field is not a {@code ChronoField}, then the result of this method is obtained by
     * invoking {@code TemporalField.getFrom(TemporalAccessor)} passing {@code this} as the
     ...
     * <p>
     * This returns a {@code LocalTime}, based on this one, with the time adjusted. The adjustment
     ...
     * <p>
     * This returns a {@code LocalTime}, based on this one, with the value for the specified field
     * changed. This can be used to change any supported field, such as the hour, minute or second.
     * If it is not possible to set the value, because the field is not supported or for some other
     ...
     * <ul>
     * <li>{@code NANO_OF_SECOND} - Returns a {@code LocalTime} with the specified nano-of-second.
     * The hour, minute and second will be unchanged.
     * <li>{@code NANO_OF_DAY} - Returns a {@code LocalTime} with the specified nano-of-day. This
     * completely replaces the time and is equivalent to {@link #ofNanoOfDay(long)}.
     * <li>{@code MICRO_OF_SECOND} - Returns a {@code LocalTime} with the nano-of-second replaced by
     * the specified micro-of-second multiplied by 1,000. The hour, minute and second will be
     * unchanged.
     * <li>{@code MICRO_OF_DAY} - Returns a {@code LocalTime} with the specified micro-of-day. This
     * completely replaces the time and is equivalent to using {@link #ofNanoOfDay(long)} with the
     * micro-of-day multiplied by 1,000.
     * <li>{@code MILLI_OF_SECOND} - Returns a {@code LocalTime} with the nano-of-second replaced by
     * the specified milli-of-second multiplied by 1,000,000. The hour, minute and second will be
     * unchanged.
     * <li>{@code MILLI_OF_DAY} - Returns a {@code LocalTime} with the specified milli-of-day. This
     * completely replaces the time and is equivalent to using {@link #ofNanoOfDay(long)} with the
     * milli-of-day multiplied by 1,000,000.
     * <li>{@code SECOND_OF_MINUTE} - Returns a {@code LocalTime} with the specified
     * second-of-minute. The hour, minute and nano-of-second will be unchanged.
     * <li>{@code SECOND_OF_DAY} - Returns a {@code LocalTime} with the specified second-of-day. The
     * nano-of-second will be unchanged.
     * <li>{@code MINUTE_OF_HOUR} - Returns a {@code LocalTime} with the specified minute-of-hour.
     * The hour, second-of-minute and nano-of-second will be unchanged.
     * <li>{@code MINUTE_OF_DAY} - Returns a {@code LocalTime} with the specified minute-of-day. The
     ...
     * AM/PM, minute-of-hour, second-of-minute and nano-of-second will be unchanged.
     * <li>{@code CLOCK_HOUR_OF_AMPM} - Returns a {@code LocalTime} with the specified
     * clock-hour-of-am-pm. The AM/PM, minute-of-hour, second-of-minute and nano-of-second will be
     * unchanged.
     * <li>{@code HOUR_OF_DAY} - Returns a {@code LocalTime} with the specified hour-of-day. The
     * minute-of-hour, second-of-minute and nano-of-second will be unchanged.
     * <li>{@code CLOCK_HOUR_OF_DAY} - Returns a {@code LocalTime} with the specified
     * clock-hour-of-day. The minute-of-hour, second-of-minute and nano-of-second will be unchanged.
     * <li>{@code AMPM_OF_DAY} - Returns a {@code LocalTime} with the specified AM/PM. The
     * hour-of-am-pm, minute-of-hour, second-of-minute and nano-of-second will be unchanged.
     * </ul>
     * <p>
     ...
     * <p>
     * Truncation returns a copy of the original time with fields smaller than the specified unit
     * set to zero. For example, truncating with the {@link ChronoUnit#MINUTES minutes} unit will
     ...
     * <p>
     * This returns a {@code LocalTime}, based on this one, with the specified amount added. The
     * amount is typically {@link Duration} but may be any other type implementing the
     ...
     * Returns a copy of this time with the specified amount added.
     * <p>
     * This returns a {@code LocalTime}, based on this one, with the amount in terms of the unit
     ...
     * fields behave as follows:
     * <ul>
     * <li>{@code NANOS} - Returns a {@code LocalTime} with the specified number of nanoseconds
     * added. This is equivalent to {@link #plusNanos(long)}.
     * <li>{@code MICROS} - Returns a {@code LocalTime} with the specified number of microseconds
     * added. This is equivalent to {@link #plusNanos(long)} with the amount multiplied by 1,000.
     * <li>{@code MILLIS} - Returns a {@code LocalTime} with the specified number of milliseconds
     * added. This is equivalent to {@link #plusNanos(long)} with the amount multiplied by
     * 1,000,000.
     * <li>{@code SECONDS} - Returns a {@code LocalTime} with the specified number of seconds added.
     * This is equivalent to {@link #plusSeconds(long)}.
     * <li>{@code MINUTES} - Returns a {@code LocalTime} with the specified number of minutes added.
     * This is equivalent to {@link #plusMinutes(long)}.
     * <li>{@code HOURS} - Returns a {@code LocalTime} with the specified number of hours added.
     * This is equivalent to {@link #plusHours(long)}.
     * <li>{@code HALF_DAYS} - Returns a {@code LocalTime} with the specified number of half-days
     * added. This is equivalent to {@link #plusHours(long)} with the amount multiplied by 12.
     * </ul>
     * <p>
     ...
     * The amount is typically {@link Duration} but may be any other type implementing the
     * {@link TemporalAmount} interface.
     * <p>
     * The calculation is delegated to the amount object by calling
    ...
    public <R> R query(TemporalQuery<R> query) {
        if (query == TemporalQueries.chronology() || query == TemporalQueries.zoneId() || query == TemporalQueries
                .zone() || query == TemporalQueries.offset()) {
            return null;
     ...
     * {@link ChronoField#NANO_OF_DAY} as the field.
     * <p>
     ...
     * <p>
     * This calculates the amount of time between two {@code LocalTime} objects in terms of a single
     * {@code TemporalUnit}. The start and end points are {@code this} and the specified time. The
     * result will be negative if the end is before the start. The {@code Temporal} passed to this
     * method is converted to a {@code LocalTime} using {@link #from(TemporalAccessor)}. For
     * example, the amount in hours between two times can be calculated using
     ...
     * two times. For example, the amount in hours between 11:30 and 13:29 will only be one hour as
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param endExclusive the end time, exclusive, which is converted to a {@code LocalTime}, not
     *            null
     * @param unit the unit to measure the amount in, not null
     * @return the amount of time between this time and the end time
     * @throws DateTimeException if the amount cannot be calculated, or the end temporal cannot be
     *             converted to a {@code LocalTime}
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     */
    @Override
     ...
     * <p>
     * This returns a {@code LocalDateTime} formed from this time at the specified date. All
     ...
     * <p>
     * This returns an {@code OffsetTime} formed from this time at the specified offset. All
    ...
    // -----------------------------------------------------------------------
    /**
     * Writes the object using a <a href="../../serialized-form.html#java.time.Ser">dedicated
     * serialized form</a>.
     * 
     * @serialData A twos-complement value indicates the remaining values are not in the stream and
     *             should be set to zero. <pre>
