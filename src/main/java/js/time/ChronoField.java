...
/**
 * @version 2014/04/25 16:33:53
 */
@JavaAPIProvider(java.time.temporal.ChronoField.class)
enum ChronoField implements TemporalField {
     ...
     * return a value for {@link #SECOND_OF_MINUTE}, {@link #SECOND_OF_DAY} or
     ...
     * stores, using integer division to remove excess precision. For example, if the
     * {@code TemporalAccessor} stores time to millisecond precision, then the nano-of-second must
     * be divided by 1,000,000 before replacing the milli-of-second.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The field is resolved in combination with
     * {@code MILLI_OF_SECOND} and {@code MICRO_OF_SECOND}.
     */
     ...
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The value is split to form
     * {@code NANO_OF_SECOND}, {@code SECOND_OF_MINUTE}, {@code MINUTE_OF_HOUR} and
     * {@code HOUR_OF_DAY} fields.
     */
     ...
     * {@link #NANO_OF_SECOND} with the value multiplied by 1,000.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The field is resolved in combination with
     * {@code MILLI_OF_SECOND} to produce {@code NANO_OF_SECOND}.
     */
     ...
     * <p>
     * When this field is used for setting a value, it should behave in the same way as setting
     * {@link #NANO_OF_DAY} with the value multiplied by 1,000.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The value is split to form
     * {@code MICRO_OF_SECOND}, {@code SECOND_OF_MINUTE}, {@code MINUTE_OF_HOUR} and
     * {@code HOUR_OF_DAY} fields.
     */
     ...
     * <p>
     * When this field is used for setting a value, it should behave in the same way as setting
     * {@link #NANO_OF_SECOND} with the value multiplied by 1,000,000.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The field is resolved in combination with
     * {@code MICRO_OF_SECOND} to produce {@code NANO_OF_SECOND}.
     */
     ...
     * <p>
     * When this field is used for setting a value, it should behave in the same way as setting
     * {@link #NANO_OF_DAY} with the value multiplied by 1,000,000.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The value is split to form
     * {@code MILLI_OF_SECOND}, {@code SECOND_OF_MINUTE}, {@code MINUTE_OF_HOUR} and
     * {@code HOUR_OF_DAY} fields.
     */
     ...
     * <p>
     * This counts the second within the minute, from 0 to 59. This field has the same meaning for
     * all calendar systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode.
     */
     ...
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The value is split to form
     * {@code SECOND_OF_MINUTE}, {@code MINUTE_OF_HOUR} and {@code HOUR_OF_DAY} fields.
     */
     ...
     * The minute-of-day.
     * <p>
     * This counts the minute within the day, from 0 to (24 * 60) - 1. This field has the same
     * meaning for all calendar systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The value is split to form
     ...
     * The hour-of-am-pm.
     * <p>
     * This counts the hour within the AM/PM, from 0 to 11. This is the hour that would be observed
     * on a standard 12-hour digital clock. This field has the same meaning for all calendar
     * systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated from 0
     * to 11 in strict and smart mode. In lenient mode the value is not validated. It is combined
     * with {@code AMPM_OF_DAY} to form {@code HOUR_OF_DAY} by multiplying the {AMPM_OF_DAY} value
     * by 12.
     */
     ...
     * <p>
     * This counts the hour within the AM/PM, from 1 to 12. This is the hour that would be observed
     * on a standard 12-hour analog wall clock. This field has the same meaning for all calendar
     * systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated from 1
     * to 12 in strict mode and from 0 to 12 in smart mode. In lenient mode the value is not
     ...
     * The hour-of-day.
     * <p>
     * This counts the hour within the day, from 0 to 23. This is the hour that would be observed on
     * a standard 24-hour digital clock. This field has the same meaning for all calendar systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated in
     * strict and smart mode but not in lenient mode. The field is combined with
     * {@code MINUTE_OF_HOUR}, {@code SECOND_OF_MINUTE} and {@code NANO_OF_SECOND} to produce a
     * {@code LocalTime}. In lenient mode, any excess days are added to the parsed date, or made
     * available via {@link java.time.format.DateTimeFormatter#parsedExcessDays()}.
     */
    HOUR_OF_DAY("HourOfDay", HOURS, DAYS, ValueRange.of(0, 23), "hour"),
    /**
     * The clock-hour-of-day.
     * <p>
     * This counts the hour within the AM/PM, from 1 to 24. This is the hour that would be observed
     * on a 24-hour analog wall clock. This field has the same meaning for all calendar systems.
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated from 1
     * to 24 in strict mode and from 0 to 24 in smart mode. In lenient mode the value is not
     ...
     * <p>
     * When parsing this field it behaves equivalent to the following: The value is validated from 0
     * to 1 in strict and smart mode. In lenient mode the value is not validated. It is combined
     * with {@code HOUR_OF_AMPM} to form {@code HOUR_OF_DAY} by multiplying the {AMPM_OF_DAY} value
     * by 12.
     */
     ...
     * system, this has values from Monday (1) to Sunday (7). The {@link DayOfWeek} class can be
     * used to interpret the result.
     * <p>
     * Most non-ISO calendar systems also define a seven day week that aligns with ISO. Those
     * calendar systems must also use the same numbering system, from Monday (1) to Sunday (7),
     * which allows {@code DayOfWeek} to be used.
     * <p>
     * Calendar systems that do not have a standard seven day week should implement this field if
     * they have a similar concept of named or numbered days within a period similar to a week. It
     * is recommended that the numbering starts from 1.
     */
     ...
     * aligned to the start of the month. This field is typically used with
     ...
     * this field. As such, day-of-month 1 to 7 will have aligned-day-of-week values from 1 to 7.
     * And day-of-month 8 to 14 will repeat this with aligned-day-of-week values from 1 to 7.
     * <p>
     * Calendar systems that do not have a seven day week should typically implement this field in
     * the same way, but using the alternate week length.
     */
     ...
     * <p>
     * This represents concept of the count of days within the period of a week where the weeks are
     * aligned to the start of the year. This field is typically used with
     * {@link #ALIGNED_WEEK_OF_YEAR}.
     * <p>
     * For example, in a calendar systems with a seven day week, the first aligned-week-of-year
     * starts on day-of-year 1, the second aligned-week starts on day-of-year 8, and so on. Within
     * each of these aligned-weeks, the days are numbered from 1 to 7 and returned as the value of
     * this field. As such, day-of-year 1 to 7 will have aligned-day-of-week values from 1 to 7. And
     * day-of-year 8 to 14 will repeat this with aligned-day-of-week values from 1 to 7.
     * <p>
     * Calendar systems that do not have a seven day week should typically implement this field in
     * the same way, but using the alternate week length.
     */
     ...
     * this has values from 1 to 31 in most months. April, June, September, November have days from
     * 1 to 30, while February has days from 1 to 28, or 29 in a leap year.
     * <p>
     * Non-ISO calendar systems should implement this field using the most recognized day-of-month
     * values for users of the calendar system. Normally, this is a count of days from 1 to the
     * length of the month.
     */
     ...
     * length of the year.
     * <p>
     * Note that a non-ISO calendar system may have year numbering system that changes at a
     * different point to the natural reset in the month numbering. An example of this is the
     * Japanese calendar system where a change of era, which resets the year number to 1, can happen
     * on any date. The era and year reset also cause the day-of-year to be reset to 1, but not the
     * month-of-year or day-of-month.
     */
    DAY_OF_YEAR("DayOfYear", DAYS, YEARS, ValueRange.of(1, 365, 366)),
    /**
     * The epoch-day, based on the Java epoch of 1970-01-01 (ISO).
     * <p>
     * This field is the sequential count of days where 1970-01-01 (ISO) is zero. Note that this
     ...
     * <p>
     * This represents concept of the count of weeks within the period of a month where the weeks
     * are aligned to the start of the month. This field is typically used with
     ...
     * <p>
     * For example, in a calendar systems with a seven day week, the first aligned-week-of-year
     * starts on day-of-year 1, the second aligned-week starts on day-of-year 8, and so on. Thus,
     * day-of-year values 1 to 7 are in aligned-week 1, while day-of-year values 8 to 14 are in
     * aligned-week 2, and so on.
     * <p>
     * Calendar systems that do not have a seven day week should typically implement this field in
     * the same way, but using the alternate week length.
     ...
     * <p>
     * This field is the sequential count of months where the first month in proleptic-year zero has
     * the value zero. Later months have increasingly larger values. Earlier months have
     ...
     * <p>
     * Non-ISO calendar systems must implement this field as per the definition above. It is just a
     * simple zero-based count of elapsed months from the start of proleptic-year 0. All calendar
     * systems with a full proleptic-year definition will have a year zero. If the calendar system
     * has a minimum year that excludes year zero, then one must be extrapolated in order for this
     ...
     * {@code DAY_OF_MONTH} fields. Whether this field or {@code YEAR} is used depends on which
     * mental model is being used. See {@link ChronoLocalDate} for more discussion on this topic.
     * <p>
     * In the default ISO calendar system, there are two eras defined, 'BCE' and 'CE'. The era 'CE'
     * is the one currently in use and year-of-era runs from 1 to the maximum value. The era 'BCE'
     * is the previous era, and the year-of-era runs backwards.
     * <p>
     ...
     * The proleptic year is not interpreted in terms of the era. See {@link #YEAR_OF_ERA} for an
     * example showing the mapping from proleptic year to year-of-era.
     * <p>
     * The standard mental model for a date is based on three concepts - year, month and day. These
     * map onto the {@code YEAR}, {@code MONTH_OF_YEAR} and {@code DAY_OF_MONTH} fields. Note that
     * there is no reference to eras. The full model for a date requires four concepts - era, year,
     * month and day. These map onto the {@code ERA}, {@code YEAR_OF_ERA}, {@code MONTH_OF_YEAR} and
     * {@code DAY_OF_MONTH} fields. Whether this field or {@code YEAR_OF_ERA} is used depends on
     * which mental model is being used. See {@link ChronoLocalDate} for more discussion on this
     * topic.
     * <p>
     * Non-ISO calendar systems should implement this field as follows. If the calendar system has
     * only two eras, before and after a fixed date, then the proleptic-year value must be the same
     * as the year-of-era value for the later era, and increasingly negative for the earlier era. If
     * the calendar system has more than two eras, then the proleptic-year value may be defined with
     * any appropriate value, although defining it to be the same as ISO may be the best option.
     */
     ...
     * In the default ISO calendar system, there are two eras defined, 'BCE' and 'CE'. The era 'CE'
     * is the one currently in use and year-of-era runs from 1 to the maximum value. The era 'BCE'
     * is the previous era, and the year-of-era runs backwards. See {@link #YEAR_OF_ERA} for a full
     * example.
     * <p>
     * Non-ISO calendar systems should implement this field to define eras. The value of the era
     * that was active on 1970-01-01 (ISO) must be assigned the value 1. Earlier eras must have
     ...
     * <p>
     * This represents the concept of the sequential count of seconds where 1970-01-01T00:00Z (ISO)
     * is zero. This field may be used with {@link #NANO_OF_SECOND} to represent the fraction of the
     * second.
     * <p>
     * An {@link Instant} represents an instantaneous point on the time-line. On their own, an
     ...
     * UTC/Greenwich. This is usually a fixed number of hours and minutes. It is equivalent to the
     * {@link ZoneOffset#getTotalSeconds() total amount} of the offset in seconds. For example,
     * during the winter Paris has an offset of {@code +01:00}, which is 3600 seconds.
     * <p>
     * This field is strictly defined to have the same meaning in all calendar systems. This is
     * necessary to ensure interoperation between calendars.
     */
     ...
     * <p>
     * This validates that the value is within the outer range of valid values returned by
     * {@link #range()}.
     * <p>
     ...
     * <p>
     * This validates that the value is within the outer range of valid values returned by
     * {@link #range()}. It also checks that all valid values are within the bounds of an
     * {@code int}.
     * <p>
     * This method checks against the range of the field in the ISO-8601 calendar system. This range
     * may be incorrect for other calendar systems. Use {@link Chronology#range(ChronoField)} to
