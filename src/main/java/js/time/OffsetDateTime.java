...
/**
 * @version 2015/08/08 22:48:54
 */
public class OffsetDateTime implements Temporal, TemporalAdjuster, Comparable<OffsetDateTime>, Serializable {
     ...
     * offsets are earlier on the time-line). This combines {@link LocalDateTime#MIN} and
     * {@link ZoneOffset#MAX}. This could be used by an application as a "far past" date-time.
     */
    public static final OffsetDateTime MIN = LocalDateTime.MIN.atOffset(ZoneOffset.MAX);

    /**
     * The maximum supported {@code OffsetDateTime}, '+999999999-12-31T23:59:59.999999999-18:00'.
     * This is the local date-time just before midnight at the end of the maximum date in the
     * minimum offset (larger negative offsets are later on the time-line). This combines
     * {@link LocalDateTime#MAX} and {@link ZoneOffset#MIN}. This could be used by an application as
     * a "far future" date-time.
     */
    ...
    /**
     * Compares this {@code OffsetDateTime} to another date-time. The comparison is based on the
     * instant.
     *
     ...
     * to obtain the current date-time. The offset will be calculated from the time-zone in the
     * clock.
     * <p>
     ...
     * <p>
     * This obtains an offset date-time based on the specified temporal. A {@code TemporalAccessor}
     * represents an arbitrary set of date and time information, which this factory converts to an
     * instance of {@code OffsetDateTime}.
     * <p>
     * The conversion will first obtain a {@code ZoneOffset} from the temporal object. It will then
     * try to obtain a {@code LocalDateTime}, falling back to an {@code Instant} if necessary. The
     * result will be the combination of {@code ZoneOffset} with either with {@code LocalDateTime}
     * or {@code Instant}. Implementations are permitted to perform optimizations such as accessing
     * those fields that are equivalent to the relevant objects.
     * <p>
     * This method matches the signature of the functional interface {@link TemporalQuery} allowing
     * it to be used as a query via method reference, {@code OffsetDateTime::from}.
     *
    ...
    public static OffsetDateTime from(TemporalAccessor temporal) {
        ...
        try {
            ...
            throw new DateTimeException("Unable to obtain OffsetDateTime from TemporalAccessor: " + temporal + " of type " + temporal
                    .getClass().getName(), ex);
        }
    }
    ...
    // -----------------------------------------------------------------------
    /**
     * Obtains an instance of {@code OffsetDateTime} from a text string such as
     ...
     * <p>
     * This method returns an object with the same {@code LocalDateTime} and the specified
     * {@code ZoneOffset}. No calculation is needed or performed. For example, if this time
     * represents {@code 2007-12-03T10:30+02:00} and the offset specified is {@code +03:00}, then
     * this method will return {@code 2007-12-03T10:30+03:00}.
     * <p>
     ...
     * {@code LocalDateTime} adjusted by the difference between the two offsets. This will result in
     * the old and new objects representing the same instant. This is useful for finding the local
     * time in a different offset. For example, if this time represents
     * {@code 2007-12-03T10:30+02:00} and the offset specified is {@code +03:00}, then this method
     * will return {@code 2007-12-03T11:30+03:00}.
     * <p>
     ...
     * <p>
     * This returns an {@code OffsetDateTime}, based on this one, with the date-time adjusted. The
     ...
     * <p>
     * This returns an {@code OffsetDateTime}, based on this one, with the value for the specified
     ...
     * date-time is unaltered. If the new offset value is outside the valid range then a
     * {@code DateTimeException} will be thrown.
     * <p>
     * The other {@link #isSupported(TemporalField) supported fields} will behave as per the
     * matching method on {@link LocalDateTime#with(TemporalField, long) LocalDateTime}. In this
     ...
     * @return an {@code OffsetDateTime} based on {@code this} with the specified field set, not
     *         null
     ...
     * <p>
     * The time and offset do not affect the calculation and will be the same in the result. If the
     ...
     * <p>
     * If the resulting {@code OffsetDateTime} is invalid, an exception is thrown. The time and
     * offset do not affect the calculation and will be the same in the result.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     ...
     * <p>
     * The time and offset do not affect the calculation and will be the same in the result. If the
     * resulting {@code OffsetDateTime} is invalid, an exception is thrown.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     ...
     * The amount is typically {@link Period} or {@link Duration} but may be any other type
     * implementing the {@link TemporalAmount} interface.
     * <p>
     ...
     * Returns a copy of this date-time with the specified amount added.
     * <p>
     * This returns an {@code OffsetDateTime}, based on this one, with the amount in terms of the
     * unit added. If it is not possible to add the amount, because the unit is not supported or for
     * some other reason, an exception is thrown.
     * <p>
     * If the field is a {@link ChronoUnit} then the addition is implemented by
     * {@link LocalDateTime#plus(long, TemporalUnit)}. The offset is not part of the calculation and
     ...
     * @return an {@code OffsetDateTime} based on this date-time with the specified amount added,
     *         not null
     * @throws DateTimeException if the addition cannot be made
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     ...
     * @return an {@code OffsetDateTime} based on this date-time with the nanoseconds added, not
     *         null
     ...
     * <p>
     * This returns an {@code OffsetDateTime}, based on this one, with the specified amount
     ...
     * <p>
     * This returns an {@code OffsetDateTime}, based on this one, with the amount in terms of the
     * unit subtracted. If it is not possible to subtract the amount, because the unit is not
     ...
     * @return an {@code OffsetDateTime} based on this date-time with the specified amount
     *         subtracted, not null
     * @throws DateTimeException if the subtraction cannot be made
     * @throws UnsupportedTemporalTypeException if the unit is not supported
     * @throws ArithmeticException if numeric overflow occurs
     ...
     * 2009-02-29 (standard year). Instead of returning an invalid result, the last valid day of the
     * month, 2009-02-28, is selected instead.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     ...
     * </ol>
     * <p>
     * For example, 2007-03-31 minus one month would result in the invalid date 2007-04-31. Instead
     * of returning an invalid result, the last valid day of the month, 2007-04-30, is selected
     * instead.
     * <p>
     * This instance is immutable and unaffected by this method call.
     ...
     * @return an {@code OffsetDateTime} based on this date-time with the months subtracted, not
     *         null
     * @throws DateTimeException if the result exceeds the supported date range
     */
    ...
    /**
     * Returns a copy of this {@code OffsetDateTime} with the specified number of minutes
     * subtracted.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     * @param minutes the minutes to subtract, may be negative
     * @return an {@code OffsetDateTime} based on this date-time with the minutes subtracted, not
     *         null
     * @throws DateTimeException if the result exceeds the supported date range
     */
    ...
    /**
     * Returns a copy of this {@code OffsetDateTime} with the specified number of seconds
     * subtracted.
     * <p>
     * This instance is immutable and unaffected by this method call.
     *
     * @param seconds the seconds to subtract, may be negative
     * @return an {@code OffsetDateTime} based on this date-time with the seconds subtracted, not
     *         null
     * @throws DateTimeException if the result exceeds the supported date range
     */
     ...
     * @return an {@code OffsetDateTime} based on this date-time with the nanoseconds subtracted,
     *         not null
     * @throws DateTimeException if the result exceeds the supported date range
     */
     ...
     * passing {@link ChronoField#EPOCH_DAY}, {@link ChronoField#NANO_OF_DAY} and
     ...
     * <p>
     * This calculates the amount of time between two {@code OffsetDateTime} objects in terms of a
     ...
     * <p>
     * The {@code Temporal} passed to this method is converted to a {@code OffsetDateTime} using
     * {@link #from(TemporalAccessor)}. If the offset differs between the two date-times, the
     * specified end date-time is normalized to have the same offset as this date-time.
     * <p>
     ...
     * This conversion will ignore the visible local date-time and use the underlying instant
     * instead. This avoids any problems with local time-line gaps or overlaps. The result might
     * have different values for fields such as hour, minute an even day.
     * <p>
     * To attempt to retain the values of the fields, use {@link #atZoneSimilarLocal(ZoneId)}. To
     * use the offset as the zone ID, use {@link #toZonedDateTime()}.
     *
     ...
     * exists. If the local date-time is in a gap or overlap according to the rules then a resolver
     * is used to determine the resultant local time and offset. This method uses
     * {@link ZonedDateTime#ofLocal(LocalDateTime, ZoneId, ZoneOffset)} to retain the offset from
     * this instance if possible.
     * <p>
     * Finer control over gaps and overlaps is available in two ways. If you simply want to use the
     * later offset at overlaps then call {@link ZonedDateTime#withLaterOffsetAtOverlap()}
     * immediately after this method.
     * <p>
     * To create a zoned date-time at the same instant irrespective of the local time-line, use
     * {@link #atZoneSameInstant(ZoneId)}. To use the offset as the zone ID, use
     ...
     * <p>
     * This returns an {@code Instant} representing the same point on the time-line as this
     * date-time.
     *
     ...
     * {@link ChronoField#INSTANT_SECONDS epoch-seconds} field. This is primarily intended for
     ...
     * </ol>
     * Values #2 and #3 represent the same instant on the time-line. When two values represent the
     * same instant, the local date-time is compared to distinguish them. This step is needed to
     * make the ordering consistent with {@code equals()}.
     *
     ...
     * <p>
     * This method differs from the comparison in {@link #compareTo} in that it only compares the
     * instant of the date-time. This is equivalent to using
     ...
     * <p>
     * The comparison is based on the local date-time and the offset. To compare for the same
     * instant on the time-line, use {@link #isEqual}. Only objects of type {@code OffsetDateTime}
