...
/**
 * @version 2013/10/24 16:12:19
 */
@JavaAPIProvider(java.util.Optional.class)
public class Optional<T> {
     ...
     * non-null, return an {@code Optional} describing the result. Otherwise return an empty
     * {@code Optional}.
     * 
     ...
     *          stream of file names, selects one that has not yet been processed, and then opens
     *          that file, returning an {@code Optional<FileInputStream>}:
     * 
     * <pre>{@code
     ...
     * {@code Optional}, and if invoked, {@code flatMap} does not wrap it with an additional
     * {@code Optional}.
     * 
