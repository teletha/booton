...
public final class OptionalDouble {
     ...
     * 
     * @implNote generally only one empty instance, {@link OptionalDouble#EMPTY}, should exist per
     *           VM.
     */
    ...
    /**
     * If a value is present in this {@code OptionalDouble}, returns the value, otherwise throws
    ...
    /**
     * Indicates whether some other object is "equal to" this OptionalDouble. The other object is
     * considered equal if:
     * <ul>
    ...
    /**
     * {@inheritDoc} Returns a non-empty string representation of this object suitable for
     * debugging. The exact presentation format is unspecified and may vary between implementations
     * and versions.
     * 
     * @implSpec If a value is present the result must include its string representation in the
     *           result. Empty and present instances must be unambiguously differentiable.
