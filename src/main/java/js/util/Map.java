 ...
 */
// @JavaAPIProvider(java.util.Map.class)
public interface Map<K, V> {
     ...
     * entry is from the iterator of this collection-view. These <tt>Map.Entry</tt> objects are
    ...
    interface Entry<K, V> {
         ...
         *             the backing map
         * @throws ClassCastException if the class of the specified value prevents it from being
         ...
         * @throws IllegalArgumentException if some property of this value prevents it from being
         *             stored in the backing map
         * @throws IllegalStateException implementations may, but are not required to, throw this
         *             exception if the entry has been removed from the backing map.
         */
         ...
         * <p>
         * The returned comparator is serializable and throws {@link NullPointerException} when
         * comparing an entry with a null key.
         * 
         ...
         * <p>
         * The returned comparator is serializable and throws {@link NullPointerException} when
         * comparing an entry with null values.
         * 
    ...
    /**
     * Performs the given action on each entry in this map, in the order entries are returned by an
     * entry set iterator (which may be unspecified), until all entries have been processed or the
     * action throws an {@code Exception}. Exceptions thrown by the action are relayed to the
     * caller.
     * <p>
     * The default implementation should be overridden by implementations if they can provide a more
     * performant implementation than an iterator-based one.
     * <p>
     * The default implementation makes no guarantees about synchronization or atomicity properties
     * of this method. Any implementation providing atomicity guarantees must override this method
     * and document its concurrency properties.
    ...
    /**
     * Replaces each entry's value with the result of invoking the given function on that entry, in
     * the order entries are returned by an entry set iterator, until all entries have been
     ...
     *             map's entry set iterator.
     * @throws ClassCastException if the class of a replacement value prevents it from being stored
     *             in this map
     * @throws NullPointerException if the specified function is null, or the specified replacement
     *             value is null, and this map does not permit null values
     * @throws ClassCastException if a replacement value is of an inappropriate type for this map
     *             (<a href="Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException if function or a replacement value is null, and this map does
     *             not permit null keys or values (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws IllegalArgumentException if some property of a replacement value prevents it from
     *             being stored in this map (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws ConcurrentModificationException if an entry is found to be removed during iteration
     * @since 1.8
     */
     ...
     *             map (<a href="Collection.html#optional-restrictions">optional</a>)
     * @throws ClassCastException if the key or value is of an inappropriate type for this map (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException if the specified key or value is null, and this map does not
     *             permit null keys or values (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws IllegalArgumentException if some property of the specified key or value prevents it
     *             from being stored in this map (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws ConcurrentModificationException if a modification of the map is detected during
     ...
     *             this map (<a href="Collection.html#optional-restrictions">optional</a>)
     * @throws ClassCastException if the key or value is of an inappropriate type for this map (<a
     *             href="Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException if the specified key or value is null, and this map does not
     *             permit null keys or values (<a
     ...
     * }</pre>
     * 
     *           The default implementation does not throw NullPointerException for maps that do not
     *           support null values if oldValue is null unless newValue is also null.
     * @param key key with which the specified value is associated
     ...
     * (unchecked) exception, the exception is rethrown, and no mapping is recorded. The most common
     * usage is to construct a new object serving as an initial mapped value or memoized result, as
     * in:
     * 
     * <pre> {@code
     ...
     * {@link java.util.concurrent.ConcurrentMap} must document whether the function is applied once
     * atomically only if the value is not present. Any class that permits null values must document
    ...
    default V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
        ...
        V v, newValue;
        return ((v = get(key)) == null && (newValue = mappingFunction.apply(key)) != null && (v = putIfAbsent(key, newValue)) == null) ? newValue
                : v;
    }
     ...
     * }</pre>
     * 
     *           In concurrent contexts, the default implementation may retry these steps when
     *           multiple threads attempt updates.
     * @param key key with which the specified value is to be associated
     * @param remappingFunction the function to compute a value
     * @return the new value associated with the specified key, or null if none
     * @throws NullPointerException if the specified key is null and this map does not support null
     *             keys, or the remappingFunction is null
     * @throws UnsupportedOperationException if the {@code put} operation is not supported by this
     *             map (<a href="Collection.html#optional-restrictions">optional</a>)
     * @throws ClassCastException if the class of the specified key or value prevents it from being
     *             stored in this map (<a href="Collection.html#optional-restrictions">optional</a>)
     ...
     * associates it with the given value. Otherwise, replaces the value with the results of the
     * given remapping function, or removes if the result is {@code null}. This method may be of use
     * when combining multiple mapped values for a key. For example, to either create or append a
     * {@code String msg} to a value mapping:
     * 
     * <pre> {@code
