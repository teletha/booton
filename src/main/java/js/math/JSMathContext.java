...
/**
 * @version 2014/03/24 23:44:41
 */
@JavaAPIProvider(MathContext.class)
class JSMathContext {
    ...
    /* ----- Public Properties ----- */
    /**
     * A {@code MathContext} object whose settings have the values required for unlimited precision
     * arithmetic. The values of the settings are: <code>
    ...
    /**
     * A {@code MathContext} object with a precision setting matching the IEEE 754R Decimal32
     * format, 7 digits, and a rounding mode of {@link RoundingMode#HALF_EVEN HALF_EVEN}, the IEEE
     * 754R default.
     */
    public static final MathContext DECIMAL32 = new MathContext(7, RoundingMode.HALF_EVEN);

    /**
     * A {@code MathContext} object with a precision setting matching the IEEE 754R Decimal64
     * format, 16 digits, and a rounding mode of {@link RoundingMode#HALF_EVEN HALF_EVEN}, the IEEE
     * 754R default.
     */
    public static final MathContext DECIMAL64 = new MathContext(16, RoundingMode.HALF_EVEN);

    /**
     * A {@code MathContext} object with a precision setting matching the IEEE 754R Decimal128
     * format, 34 digits, and a rounding mode of {@link RoundingMode#HALF_EVEN HALF_EVEN}, the IEEE
     * 754R default.
     */
    ...
    /**
     * Constructs a new {@code MathContext} with the specified precision and the
     * {@link RoundingMode#HALF_UP HALF_UP} rounding mode.
     *
     ...
     */
    public JSMathContext(int setPrecision) {
     ...
     */
    public JSMathContext(int setPrecision, RoundingMode setRoundingMode) {
    ...
    /**
     * Constructs a new {@code MathContext} from a string. The string must be in the same format as
     * that produced by the {@link #toString} method.
     * <p>
     * An {@code IllegalArgumentException} is thrown if the precision section of the string is out
     ...
     */
    public JSMathContext(String val) {
        boolean bad = false;
        int setPrecision;
        if (val == null) {
    ...
    /**
     * Returns the roundingMode setting. This will be one of {@link RoundingMode#CEILING},
     * {@link RoundingMode#DOWN}, {@link RoundingMode#FLOOR}, {@link RoundingMode#HALF_DOWN},
     * {@link RoundingMode#HALF_EVEN}, {@link RoundingMode#HALF_UP},
    ...
    public boolean equals(Object x) {
        JSMathContext mc;
        if (!(x instanceof JSMathContext)) {
            return false;
        }
        mc = (JSMathContext) x;
        return mc.precision == this.precision && mc.roundingMode == this.roundingMode; // no need
                                                                                       // for
                                                                                       // .equals()
    }
     ...
     * (separated by a single space character, <tt>'&#92;u0020'</tt>, and with no leading or
     * trailing white space), as follows:
     * <ol>
     ...
     * <li>The string {@code "roundingMode="}, immediately followed by the value of the
     * {@code roundingMode} setting as a word. This word will be the same as the name of the
