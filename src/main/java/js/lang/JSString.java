...
class JSString implements Comparable<String>, CharSequence {
     ...
     * {@code String} object as determined by the {@link #equals(Object)} method, then the string
     * from the pool is returned. Otherwise, this {@code String} object is added to the pool and a
    ...
    public static String format(String format, Object... args) {
        return format; // TODO implemetation
    }
