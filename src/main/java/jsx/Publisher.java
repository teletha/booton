...
/**
 * @version 2013/12/10 11:27:51
 */
class Publisher {

    static final Map<PublishableInterface, Publisher> manager = new HashMap();
     ...
     * </p>
     */
    public void register(SubscribableInterface subscribable) {
     ...
     * </p>
     */
    public void unregister(SubscribableInterface subscribable) {
    ...
    private static class Listener {
         ...
         * @param method
         */
        private Listener(SubscribableInterface instance, Method method) {
