...
import teemowork.model.variable.VariableResolver.Per5LevelForNautilus;
...
public class Skill extends Describable<SkillDescriptor> {
    ...
    static {
        ...
        TwinBite.update(P309)
                .active("次に行う通常攻撃が二回攻撃になり、ニ回目の攻撃は{1}を与える。Dragon Form時は対象の周囲にいる敵ユニットにも同様の効果を与える。建物以外の対象を通常攻撃する毎に{2}する。");
        Burnout.update()
        ...
        DragonsDescent.update()
                ...
                .variable(3, MagicDamage, 200, 100, ap(0.7))
        ...
        InfiniteDuress.update()
                .active("対象の敵Championに突撃し{2}を与えて、その間{3}を得て0.42秒毎に{1}を、計5回で{4}を与える。")
                ...
                .cd(90, -10)
                .range(700);
        InfiniteDuress.update(P307).active("対象の敵Championに突撃し{2}を与えて、その間{3}を得て0.3秒毎に{1}を、計5回で{4}を与える。");
    ...
    private static void Kassadin() {
        ...
        NullSphere.update()
                ...
                .cd(9)
                .range(650);
        NullSphere.update(P313).variable(1, MagicDamage, 80, 35, ap(0.7)).variable(2, Silence, 1.5, 0.25).mana(70, 5);
        NetherBlade.update()
    ...
    private static void KhaZix() {
        ...
        VoidSpike.update(P308)
                ...
                .mana(55, 5);
        VoidSpike.update(P313).variable(4, MSSlowRatio, 30);
        Leap.update()
    ...
    private static void Lulu() {
        ...
        PixFaerieCompanion.update(P314).variable(1, MagicDamage, new Per2Level(3, 3), ap(0.05), null);
        Glitterlance.update()
        ...
        HelpPix.update()
                ...
                .cd(10)
                .range(650);
        HelpPix.update(P314).variable(2, MagicDamage, 80, 50, ap(0.4));
        WildGrowth.update()
    ...
    private static void Nautilus() {
        ...
        StaggeringBlow.update(P314).variable(2, Snare, new Per5LevelForNautilus(0.5, 0.25));
        DredgeLine.update()
    ...
    private static void Olaf() {
        ...
        Undertow.update(P313).variable(4, Time, 1.5, 0, amplify(Distance, 1)).mana(60);
        ...
        ViciousStrikes.update(P312)
                ...
                .mana(30);
        ViciousStrikes.update(P313).variable(4, ASRatio, 40, 10);
        ...
        RecklessSwing.update(P313).cost(Health, new Diff(21, 13.5, 5), ad(0.12));
        Ragnarok.update()
    ...
    private static void Sivir() {
        ...
        SpellShield.update()
                ...
                .mana(75)
                .cd(22, -3);
        SpellShield.update(P313).mana(0).variable(2, RestoreMana, 60, 15);
        OnTheHunt.update()
                ...
                .cd(100, -10)
                .range(1200);
        OnTheHunt.update(P313)
                .passive("Ricochetの起動中は{1}する。")
                .variable(-1, ASRatio, 40, 20)
                .active("10秒間{2}の味方は{3}する。一度範囲内に入れば、Sivirから離れても効果が持続する。増加移動速度は4秒かけて20%まで減少する。")
    ...
    private static void Taric() {
        ...
        Shatter.update(P314).variable(5, MagicDamage, 40, 40, amplify(AR, 0.5));
        Dazzle.update()
    ...
    private static void Zed() {
        ...
        LivingShadow.update()
                ...
                .variable(5, ProjectileSpeed, 2500)
                .cost(Energy, 40, -5)
                .cd(22, -1.5)
                .range(550);
        LivingShadow.update(P306).cd(18, -1);
        LivingShadow.update(P307).variable(2, Radius, 700);
        LivingShadow.update(P313).variable(5, ProjectileSpeed, 1500);
        ShadowSlash.update()
    ...
    private static void Ziggs() {
        ...
        ShortFuse.update(P313).variable(1, MagicDamage, new Per1Level(new double[] {20, 27, 34, 41, 48, 56, 64, 72, 80,
                88, 96, 105, 114, 123, 132, 141, 150, 160}), ap(0.35), null);
        BouncingBomb.update()
        ...
        HexplosiveMinefield.update()
                ...
                .cd(16)
                .range(900);
        HexplosiveMinefield.update(P313).variable(5, Radius, 150);
