...
public class MasterySeason4 extends Mastery {
    ...
    /** Season3 Mastery */
    public static final MasterySeason4 SummonersWrath = new MasterySeason4("Summoner's Wrath", 1, Offense, 0);
    ...
    /** Season3 Mastery */
    public static final MasterySeason4 Butcher = new MasterySeason4("Butcher", 2, Offense, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Deadliness = new MasterySeason4("Deadliness", 4, Offense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Blast = new MasterySeason4("Blast", 4, Offense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Destruction = new MasterySeason4("Destruction", 1, Offense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Havoc = new MasterySeason4("Havoc", 3, Offense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 WeaponExpertise = new MasterySeason4("Weapon Expertise", 1, Offense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 ArcaneKnowledge = new MasterySeason4("Arcane Knowledge", 1, Offense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 Lethality = new MasterySeason4("Lethality", 2, Offense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 BruteForce = new MasterySeason4("Brute Force", 2, Offense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 MentalForce = new MasterySeason4("Mental Force", 3, Offense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Spellsword = new MasterySeason4("Spellsword", 1, Offense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Frenzy = new MasterySeason4("Frenzy", 1, Offense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 Sunder = new MasterySeason4("Sunder", 3, Offense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 Archmage = new MasterySeason4("Archmage", 4, Offense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 Executioner = new MasterySeason4("Executioner", 1, Offense, 5);

    /** Season3 Mastery */
    public static final MasterySeason4 SummonersResolve = new MasterySeason4("Summoner's Resolve", 1, Defense, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Perseverance = new MasterySeason4("Perseverance", 3, Defense, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Durability = new MasterySeason4("Durability", 4, Defense, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 ToughSkin = new MasterySeason4("Tough Skin", 2, Defense, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Hardiness = new MasterySeason4("Hardiness", 3, Defense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Resistance = new MasterySeason4("Resistance", 3, Defense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 BladedArmor = new MasterySeason4("Bladed Armor", 1, Defense, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Unyielding = new MasterySeason4("Unyielding", 2, Defense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 Relentless = new MasterySeason4("Relentless", 2, Defense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 VeteransScar = new MasterySeason4("Veteran's Scars", 1, Defense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 Safeguard = new MasterySeason4("Safeguard", 1, Defense, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 Block = new MasterySeason4("Block", 1, Defense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Tenacious = new MasterySeason4("Tenacious", 3, Defense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Juggernaut = new MasterySeason4("Juggernaut", 3, Defense, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Defender = new MasterySeason4("Defender", 1, Defense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 LegendaryArmor = new MasterySeason4("Legendary Armor", 3, Defense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 GoodHands = new MasterySeason4("Good Hands   ", 1, Defense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 ReinforcedArmor = new MasterySeason4("Reinforced Armor ", 1, Defense, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 HonorGuard = new MasterySeason4("Honor Guard", 1, Defense, 5);

    /** Season3 Mastery */
    public static final MasterySeason4 SummonersInsight = new MasterySeason4("Summoner's Insight", 1, Utility, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Wanderer = new MasterySeason4("Wanderer", 3, Utility, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Meditation = new MasterySeason4("Meditation", 3, Utility, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 ImprovedRecall = new MasterySeason4("Improved Recall", 1, Utility, 0);

    /** Season3 Mastery */
    public static final MasterySeason4 Scout = new MasterySeason4("Scout", 1, Utility, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Mastermind = new MasterySeason4("Mastermind", 3, Utility, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 ExpandedMind = new MasterySeason4("Expanded Mind", 3, Utility, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Artificer = new MasterySeason4("Artificer", 2, Utility, 1);

    /** Season3 Mastery */
    public static final MasterySeason4 Greed = new MasterySeason4("Greed", 4, Utility, 2);
    ...
    /** Season3 Mastery */
    public static final MasterySeason4 Biscuiteer = new MasterySeason4("Biscuiteer", 1, Utility, 2);

    /** Season3 Mastery */
    public static final MasterySeason4 Wealth = new MasterySeason4("Wealth", 2, Utility, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Awareness = new MasterySeason4("Awareness", 4, Utility, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 StrengthOfSpirit = new MasterySeason4("Strength of Spirit", 3, Utility, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Explorer = new MasterySeason4("Explorer", 1, Utility, 3);

    /** Season3 Mastery */
    public static final MasterySeason4 Pickpocket = new MasterySeason4("Pickpocket", 1, Utility, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 Intelligence = new MasterySeason4("Intelligence", 3, Utility, 4);

    /** Season3 Mastery */
    public static final MasterySeason4 Nimble = new MasterySeason4("Nimble", 1, Utility, 5);
