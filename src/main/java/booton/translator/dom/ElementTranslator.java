...
/**
 * @version 2012/12/02 10:21:33
 */
class ElementTranslator extends AbstractDOMSupport<Element> {
     ...
     */
    public String setAttribute(String name, String value) throws DOMException {
        return that + ".setAttribute(" + param(0) + "," + param(1) + ")";
    }
