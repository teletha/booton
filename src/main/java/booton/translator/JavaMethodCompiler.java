    ...
    public void visitTypeInsn(int opcode, String type) {
        ...
        case INSTANCEOF:
            ...
            if (clazz == Object.class || clazz == NativeObject.class) {
                ...
                current.addOperand(Javascript.computeClass(clazz) + "." + Javascript.computeMethodName(assignable) + "(" + current.remove(0) + "." + Javascript.writeMethod(Object.class, "$getClass") + ")");
            } else {
