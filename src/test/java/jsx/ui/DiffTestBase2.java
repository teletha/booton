...
public class DiffTestBase2 {
     ...
     */
    protected void assertDiff(VirtualStructure2 prev, VirtualStructure2 next, int expectedOperationCount) {
    ...
    protected void assertDiff(VirtualElement prev, VirtualElement next, int expectedOperationCount) {
        ...
        assert expectedOperationCount == ops.size() : message(prevNode, nextNode, ops, ops.size());
