...
public class Skill {
    ...
    static {
        ...
        Despair.update()
                ...
                .variable(1, MagicDamage, 8, 4, amplify(TargetHealth, 1.5, 0.3, ap(0.01)))
        ...
        DarkFrenzy.update()
                ...
                .variable(1, MS, 4, 4)
                .conditional(1)
                .active("3秒間{2}して、{3}と{4}を得る。敵Championキル/アシスト時に、このスキルのCDが解消される。")
                .variable(2, MS, 0, 0, amplify(MS, 0.3, 0.1))
