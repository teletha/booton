...
public class ImageUtils {
     ...
     * RGB or BGR, int or byte packed) but the number of components (w/o alpha, w alpha, gray) must
     * match does not unmange the image for all (A)RGN and (A)BGR and gray imaged
     */
