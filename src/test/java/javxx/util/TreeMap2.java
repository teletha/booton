 ...
 * <p>
 * This implementation provides guaranteed log(n) time cost for the {@code containsKey}, {@code get}, {@code put} and {@code remove} operations. Algorithms are adaptations of those in Cormen,
 ...
 * explicit comparator is provided, must be <em>consistent
 * with {@code equals}</em> if this sorted map is to correctly implement the {@code Map} interface.
 * (See {@code Comparable} or {@code Comparator} for a precise definition of
 * <em>consistent with equals</em>.) This is so because the {@code Map} interface is defined in
 * terms of the {@code equals} operation, but a sorted map performs all key comparisons using its
 * {@code compareTo} (or {@code compare}) method, so two keys that are deemed equal by this method
 * are, from the standpoint of the sorted map, equal. The behavior of a sorted map <em>is</em>
...
public class TreeMap2<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, java.io.Serializable {
     ...
     * be <em>mutually comparable</em>: {@code k1.compareTo(k2)} must not throw a
     ...
     * inserted into the map must be <em>mutually
     * comparable</em> by the given comparator: {@code comparator.compare(k1,
     * k2)} must not throw a {@code ClassCastException} for any keys {@code k1} and {@code k2} in
     * the map. If the user attempts to put a key into the map that violates this constraint, the
     * {@code put(Object
     ...
     * the {@link Comparable} interface. Furthermore, all such keys must be
     ...
     * mapping.)
     * <p>
     * A return value of {@code null} does not <em>necessarily</em> indicate that the map contains
    ...
    /**
     * Returns a shallow copy of this {@code TreeMap} instance. (The keys and values themselves are
     * not cloned.)
     * 
     ...
     * mapping from the map, via the {@code Iterator.remove}, {@code Set.remove}, {@code removeAll},
     * {@code retainAll}, and {@code clear} operations. It does not support the {@code add} or
     ...
     * via the {@code Iterator.remove}, {@code Collection.remove}, {@code removeAll},
     * {@code retainAll} and {@code clear} operations. It does not support the {@code add} or
     * {@code addAll} operations.
     */
     ...
     * is in progress (except through the iterator's own {@code remove} operation, or through the
     * {@code setValue} operation on a map entry returned by the iterator) the results of the
     * iteration are undefined. The set supports element removal, which removes the corresponding
     * mapping from the map, via the {@code Iterator.remove}, {@code Set.remove}, {@code removeAll},
     * {@code retainAll} and {@code clear} operations. It does not support the {@code add} or
     * {@code addAll} operations.
    ...
    class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return TreeMap2.this.containsValue(o);
        }
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
        ...
        public Iterator<E> iterator() {
            if (m instanceof TreeMap)
                return ((TreeMap2<E, Object>) m).keyIterator();
            else
                return (Iterator<E>) (((TreeMap2.NavigableSubMap) m).keyIterator());
        }

        public Iterator<E> descendingIterator() {
            if (m instanceof TreeMap)
                return ((TreeMap2<E, Object>) m).descendingKeyIterator();
            else
                return (Iterator<E>) (((TreeMap2.NavigableSubMap) m).descendingKeyIterator());
        }
     ...
     */
    static <K, V> Map.Entry<K, V> exportEntry(TreeMap2.Entry<K, V> e) {
     ...
     */
    static <K, V> K keyOrNull(TreeMap2.Entry<K, V> e) {
    ...
    abstract static class NavigableSubMap<K, V> extends AbstractMap<K, V>
        ...
        NavigableSubMap(TreeMap2<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
            if (!fromStart && !toEnd) {
        ...
        final TreeMap2.Entry<K, V> absLowest() {
            TreeMap2.Entry<K, V> e = (fromStart ? m.getFirstEntry() : (loInclusive ? m.getCeilingEntry(lo)
                    : m.getHigherEntry(lo)));
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final TreeMap2.Entry<K, V> absHighest() {
            TreeMap2.Entry<K, V> e = (toEnd ? m.getLastEntry() : (hiInclusive ? m.getFloorEntry(hi)
                    : m.getLowerEntry(hi)));
            return (e == null || tooLow(e.key)) ? null : e;
        }

        final TreeMap2.Entry<K, V> absCeiling(K key) {
            if (tooLow(key)) return absLowest();
            TreeMap2.Entry<K, V> e = m.getCeilingEntry(key);
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final TreeMap2.Entry<K, V> absHigher(K key) {
            if (tooLow(key)) return absLowest();
            TreeMap2.Entry<K, V> e = m.getHigherEntry(key);
            return (e == null || tooHigh(e.key)) ? null : e;
        }

        final TreeMap2.Entry<K, V> absFloor(K key) {
            if (tooHigh(key)) return absHighest();
            TreeMap2.Entry<K, V> e = m.getFloorEntry(key);
            return (e == null || tooLow(e.key)) ? null : e;
        }

        final TreeMap2.Entry<K, V> absLower(K key) {
            if (tooHigh(key)) return absHighest();
            TreeMap2.Entry<K, V> e = m.getLowerEntry(key);
            return (e == null || tooLow(e.key)) ? null : e;
        }

        /** Returns the absolute high fence for ascending traversal */
        final TreeMap2.Entry<K, V> absHighFence() {
            return (toEnd ? null : (hiInclusive ? m.getHigherEntry(hi) : m.getCeilingEntry(hi)));
        }

        /** Return the absolute low fence for descending traversal */
        final TreeMap2.Entry<K, V> absLowFence() {
        ...
        abstract TreeMap2.Entry<K, V> subLowest();

        abstract TreeMap2.Entry<K, V> subHighest();

        abstract TreeMap2.Entry<K, V> subCeiling(K key);

        abstract TreeMap2.Entry<K, V> subHigher(K key);

        abstract TreeMap2.Entry<K, V> subFloor(K key);

        abstract TreeMap2.Entry<K, V> subLower(K key);
        ...
        public final Map.Entry<K, V> pollFirstEntry() {
            TreeMap2.Entry<K, V> e = subLowest();
        ...
        public final Map.Entry<K, V> pollLastEntry() {
            TreeMap2.Entry<K, V> e = subHighest();
            Map.Entry<K, V> result = exportEntry(e);
            if (e != null) m.deleteEntry(e);
            return result;
        }
        ...
        public final NavigableSet<K> navigableKeySet() {
            ...
            return (nksv != null) ? nksv : (navigableKeySetView = new TreeMap2.KeySet(this));
        }
        ...
        abstract class EntrySetView extends AbstractSet<Map.Entry<K, V>> {
            ...
            public boolean isEmpty() {
                TreeMap2.Entry<K, V> n = absLowest();
            ...
            public boolean contains(Object o) {
                ...
                TreeMap2.Entry node = m.getEntry(key);
            ...
            public boolean remove(Object o) {
                ...
                K key = entry.getKey();
                if (!inRange(key)) return false;
                TreeMap2.Entry<K, V> node = m.getEntry(key);
        ...
        abstract class SubMapIterator<T> implements Iterator<T> {
            ...
            TreeMap2.Entry<K, V> lastReturned;

            TreeMap2.Entry<K, V> next;

            final Object fenceKey;

            int expectedModCount;

            SubMapIterator(TreeMap2.Entry<K, V> first, TreeMap2.Entry<K, V> fence) {
            ...
            final TreeMap2.Entry<K, V> nextEntry() {
                TreeMap2.Entry<K, V> e = next;
            ...
            final TreeMap2.Entry<K, V> prevEntry() {
                TreeMap2.Entry<K, V> e = next;
                if (e == null || e.key == fenceKey) throw new NoSuchElementException();
                if (m.modCount != expectedModCount) throw new ConcurrentModificationException();
                next = predecessor(e);
        ...
        final class SubMapEntryIterator extends SubMapIterator<Map.Entry<K, V>> {
            ...
            SubMapEntryIterator(TreeMap2.Entry<K, V> first, TreeMap2.Entry<K, V> fence) {
                super(first, fence);
            }
        ...
        final class SubMapKeyIterator extends SubMapIterator<K> {
            ...
            SubMapKeyIterator(TreeMap2.Entry<K, V> first, TreeMap2.Entry<K, V> fence) {
                super(first, fence);
            }
        ...
        final class DescendingSubMapEntryIterator extends SubMapIterator<Map.Entry<K, V>> {
            ...
            DescendingSubMapEntryIterator(TreeMap2.Entry<K, V> last, TreeMap2.Entry<K, V> fence) {
                super(last, fence);
            }
        ...
        final class DescendingSubMapKeyIterator extends SubMapIterator<K> {
            ...
            DescendingSubMapKeyIterator(TreeMap2.Entry<K, V> last, TreeMap2.Entry<K, V> fence) {
                super(last, fence);
            }
    ...
    static final class AscendingSubMap<K, V> extends NavigableSubMap<K, V> {
        ...
        AscendingSubMap(TreeMap2<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
        ...
        TreeMap2.Entry<K, V> subLowest() {
            return absLowest();
        }

        TreeMap2.Entry<K, V> subHighest() {
            return absHighest();
        }

        TreeMap2.Entry<K, V> subCeiling(K key) {
            return absCeiling(key);
        }

        TreeMap2.Entry<K, V> subHigher(K key) {
            return absHigher(key);
        }

        TreeMap2.Entry<K, V> subFloor(K key) {
            return absFloor(key);
        }

        TreeMap2.Entry<K, V> subLower(K key) {
            return absLower(key);
        }
    }
    ...
    static final class DescendingSubMap<K, V> extends NavigableSubMap<K, V> {
        ...
        DescendingSubMap(TreeMap2<K, V> m, boolean fromStart, K lo, boolean loInclusive, boolean toEnd, K hi, boolean hiInclusive) {
            super(m, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
        }
     ...
     * of TreeMap that did not support NavigableMap. It translates an old-version SubMap into a
    ...
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V>, java.io.Serializable {
        ...
        private Object readResolve() {
            return new AscendingSubMap(TreeMap2.this, fromStart, fromKey, true, toEnd, toKey, false);
        }
     ...
     */
    static <K, V> TreeMap2.Entry<K, V> successor(Entry<K, V> t) {
        if (t == null)
            return null;
    ...
    /**
     * Balancing operations. Implementations of rebalancings during insertion and deletion are
     * slightly different than the CLR version. Rather than using dummy nilnodes, we use a set of
     * accessors that deal properly with null. They are used to avoid messiness surrounding nullness
    ...
    /**
     * Save the state of the {@code TreeMap} instance to a stream (i.e., serialize it).
     * 
     * @serialData The <em>size</em> of the TreeMap (the number of key-value mappings) is emitted
     *             (int), followed by the key (Object) and value (Object) for each key-value mapping
     *             represented by the TreeMap2. The key-value mappings are emitted in key-order (as
     *             determined by the TreeMap's Comparator, or by the keys' natural ordering if the
     *             TreeMap has no Comparator).
     */
     ...
     * The four formats that this method accepts are: 1) An iterator of Map.Entries. (it != null,
     * defaultVal == null). 2) An iterator of keys. (it != null, defaultVal != null). 3) A stream of
     * alternating serialized keys and values. (it == null, defaultVal == null). 4) A stream of
     * serialized keys. (it == null, defaultVal != null). It is assumed that the comparator of the
     * TreeMap is already set prior to calling this method.
     * 
     ...
     * assumed that the comparator and size fields of the TreeMap are already set prior to calling
     * this method. (It ignores both fields.)
     * 
    ...
    private final Entry<K, V> buildFromSorted(int level, int lo, int hi, int redLevel, Iterator it, java.io.ObjectInputStream str, V defaultVal)
         ...
         * with right subtree. The lo and hi arguments are the minimum and maximum indices to pull
         * out of the iterator or stream for current subtree. They are not actually indexed, we just
         * proceed sequentially, ensuring that items are extracted in corresponding order.
         */
