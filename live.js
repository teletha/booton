...
$0:function(){}});boot.define("z",{
// booton.translator.web.Location#<init>()
$0:function(){}});boot.define("L",{
...
L:function(){return new boot.L(this,0);}});boot.define("BF",{
// booton.translator.web.WebSocket#<init>()
$0:function(){}});boot.defineNative("MessageEvent",{
// booton.translator.web.WebSocket$MessageEvent#<init>()
$0:function(){}});boot.define("BD",boot.BF,{
...
message:function(A,B){B=A.data;if(B.endsWith("css")==0){window.location.reload(0);}else{$("link[href^='"+B+"']").attr("href",""+B+"?"+new Date().getTime());}}});boot.define("BC",{
// booton.live.LiveCoding$1#<init>()
$0:function(){},
// booton.live.LiveCoding$1#handler(booton.translator.web.jQuery$Event)
handler:function(A){console.log(A);}});boot.define("BB",{
// booton.live.LiveCoding#<init>()
$0:function(){},
// booton.live.LiveCoding#jsmain()
_A:function(){$(window).on("error",new boot.BC(0));WebSocket.connect("ws://localhost:10021/live"+window.location.pathname,new boot.BD(0));}});try {boot.BB.A();} catch(e) {console.log(e)}